...
function Dropdow({ categories, categoryChange, onSort }) {
  ...
  return (
    <div className="flex flex-row gap-5 justify-between">
      ...
      <div className="relative ">
        <select className="lg:px-5.5 lg:py-2.5 px-2.5 py-2.5 pr-[2rem] rounded-lg border border-gray-400/40  appearance-none lg:pr-[4rem] focus:ring-offset-2 focus:outline-none focus:ring-2 focus:ring-[#00BFFF] " onChange={(e)=>onSort(e.target.value)}>
