...
function Actions({categories,categoryChange,onSort}) {
  ...
  return (
    <div className='flex md:flex-row flex-col gap-5 justify-between items-center px-[1.3rem] py-[1.5rem]  bg-neutral-100'>
        ...
        <Dropdow categories={categories}
          categoryChange={categoryChange}
          onSort={onSort}/>
        </div>
        <button className='lg:px-5.5 lg:py-2.5 px-2.5 py-2.5 rounded-lg border border-gray-400/40 shrink-0 ' >Clear Filters</button>
    </div>
  )
}
